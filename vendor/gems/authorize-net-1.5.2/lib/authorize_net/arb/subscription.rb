module AuthorizeNet::ARB
  ...
  class Subscription
    ...
    attr_accessor :name, :length, :unit, :start_date, :total_occurrences, :trial_occurrences, :amount, :trial_amount, :invoice_number, :description, :subscription_id, :credit_card, :billing_address, :shipping_address, :customer, :bank_account
    ...
    def to_hash
      ...
      hash.merge!(@bank_account.to_hash) unless @bank_account.nil?
