Feature: Admin user management
  ...
  Scenario: List users
    ...
    Then I should receive the following CSV:
      ...
      | First           | Last           | csvuser@example.com | Test Organization | 100 Test St      |                    | New York | NY    | 10001    |              |            |                     |                          | test                             |                                    |                |                      |                       | Bill               | Lastname          | 100 Test St     | New York     | NY            | 10001            | 555-555-1212         | bill_lastname@example.com |               | Credit Card  | 0027    | 03/29/2024         | $1.00                | 1                                  | $1.00               | 1/2027                  |
