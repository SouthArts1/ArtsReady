class Answer < ActiveRecord::Base
  ...
  def add_todo_items
    question.action_items.active.each do |i|
      todos.create_or_reset(:action_item => i, :organization => assessment.organization, :description => i.description, :critical_function => question.critical_function, :priority => priority)
